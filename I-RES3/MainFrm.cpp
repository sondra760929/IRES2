...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndToolbar.Create(_T("Toolbar"), this, CRect(0, 0, 24, 200), TRUE, ID_VIEW_TOOLBAR1, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_LEFT))
	{
	...
	//m_wndToolbar.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_wndToolbar);
	m_wndToolbar.EnableGripper(FALSE);

	m_wndToolbar.ShowPane(FALSE, FALSE, FALSE);
	m_wndToolbar.SetToolbar(0);
