...
// I-RES2.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CIRES2App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CIRES2App::OnAppAbout)
...
CIRES2App::CIRES2App()
{
	...
	SetAppID(_T("I-RES2.AppID.NoVersion"));
...
BOOL CIRES2App::InitInstance()
{
	...
	// 적절한 내용으로 수정해야 합니다.
	SetRegistryKey(_T("I-RES"));
	LoadStdProfileSettings(4);  // MRU를 포함하여 표준 INI 파일 옵션을 로드합니다.
	main_key = AfxGetApp()->GetAppRegistryKey();
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CIRES2Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CIRES2View));
	if (!pDocTemplate)
		return FALSE;
...
void CIRES2App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CIRES2App 사용자 지정 로드/저장 메서드

void CIRES2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CIRES2App::LoadCustomState()
{
}

void CIRES2App::SaveCustomState()
{
}
