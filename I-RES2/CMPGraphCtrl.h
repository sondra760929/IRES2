...
class CMPGraphCtrl : public COleDispatchDriver
{
public:
	CMPGraphCtrl() {} // COleDispatchDriver 기본 생성자를 호출합니다.
	CMPGraphCtrl(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMPGraphCtrl(const CMPGraphCtrl& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
