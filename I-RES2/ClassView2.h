...
class CIRES2View;
class CClassView2 : public CDockablePane
{
public:
	CClassView2() noexcept;
	virtual ~CClassView2();
	...
	void SetEstimationStatus(bool is_on);
